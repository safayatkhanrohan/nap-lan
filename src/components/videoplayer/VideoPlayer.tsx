...
const VideoPlayer = () => {
     ...
     return (
          <div className="relative w-max mx-auto">
               ...
               <div className="absolute -left-20 -top-20 z-10 hidden md:block">
                    <img src={sparkleUp} alt="Sparkle Up" className="w-32 h-32" />
               </div>
               {/* Sparkle Down - Hidden on mobile */}
               <div className="absolute -right-20 -bottom-20 z-10 hidden md:block">
                    <img src={sparkleDown} alt="Sparkle Down" className="w-32 h-32" />
               </div>

               {/* 210K Card - Hidden on mobile */}
               <div className="w-[220px] h-[100px] rounded-[20px] flex justify-center items-center flex-col absolute shadow-2xl top-24 right-0 translate-x-1/2 bg-white z-10 hidden md:block">
                    <div
               ...
               <div className="w-[270px] h-[100px] rounded-[20px] flex justify-center items-center flex-col shadow-2xl absolute bottom-24 -left-0 -translate-x-1/2 bg-white z-10 hidden md:block">
               ...
               >
                    <div className="relative group">
                         ...
                         <div className="absolute bottom-0 left-0 z-20 right-0 bg-gradient-to-t from-black/80 to-transparent p-4 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
                              {/* Progress bar */}
