...
const CTA = ({ imgSrc = "bg-[url('/images/cta/image.png')]"}: {imgSrc?: string}) => {
     return (
          <div className="text-white bg-[#A15BA8] max-w-7xl mx-auto px-16 rounded-4xl h-[450px] mb-20">
               <div className="flex h-full">
                    ...
                    <div className="relative flex-1">
                              <div className={`${imgSrc} bg-cover bg-no-repeat w-[450px] h-[530px] absolute -bottom-3 right-0 z-10`}></div>
                    </div>
               </div>
          </div>
     );
